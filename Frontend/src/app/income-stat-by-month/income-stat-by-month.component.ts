...
import {IncomeStatByMonth} from "../classes/income-stat-by-month";

@Component({
  selector: 'app-income-stat-by-month',
  templateUrl: './income-stat-by-month.component.html',
  styleUrls: ['./income-stat-by-month.component.css']
})
export class IncomeStatByMonthComponent {

  statsByMonths: IncomeStatByMonth[] = [
  ...
  getStatistics() {
    this._statisticsService.incomeGetStatsByMonth().subscribe(stats => {
